...
cmp_index_ref_load = 0;
cmp_index_ref_load = 0;
Fr_sub(&expaux[0],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 10]); // line circom 98
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 1; i++){
...
LessEqThan_4_create(mySignalStart+20,3+ctx_index+1,ctx,new_cmp_name,myId);
...
IsInRange_5_create(mySignalStart+40,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "check_upper";
IsInRange_6_create(mySignalStart+78,14+ctx_index+1,ctx,new_cmp_name,myId);
...
IsEqual_1_create(mySignalStart+116,21+ctx_index+1,ctx,new_cmp_name,myId);
...
IsEqual_1_create(mySignalStart+192,38+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 38+ctx_index+1;
}
{
std::string new_cmp_name = "is_c";
IsEqual_1_create(mySignalStart+198,40+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 40+ctx_index+1;
}
{
std::string new_cmp_name = "is_e";
IsEqual_1_create(mySignalStart+204,42+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 42+ctx_index+1;
}
{
std::string new_cmp_name = "is_f";
IsEqual_1_create(mySignalStart+210,44+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 44+ctx_index+1;
}
{
std::string new_cmp_name = "is_h";
IsEqual_1_create(mySignalStart+216,46+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 46+ctx_index+1;
}
{
std::string new_cmp_name = "is_l";
IsEqual_1_create(mySignalStart+222,48+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 48+ctx_index+1;
}
{
std::string new_cmp_name = "is_t";
IsEqual_1_create(mySignalStart+228,50+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 50+ctx_index+1;
}
{
std::string new_cmp_name = "is_v";
IsEqual_1_create(mySignalStart+234,52+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 52+ctx_index+1;
}
{
std::string new_cmp_name = "AN";
IsAlphanumeric_8_create(mySignalStart+28,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "eval_st_0";
IsEqual_1_create(mySignalStart+150,24+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 24+ctx_index+1;
}
{
std::string new_cmp_name = "eval_st_1";
IsEqual_1_create(mySignalStart+156,26+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 26+ctx_index+1;
}
{
std::string new_cmp_name = "eval_st_2";
IsEqual_1_create(mySignalStart+168,30+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 30+ctx_index+1;
}
{
std::string new_cmp_name = "eval_st_3";
IsEqual_1_create(mySignalStart+174,32+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 32+ctx_index+1;
}
{
std::string new_cmp_name = "eval_st_4";
IsEqual_1_create(mySignalStart+180,34+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 34+ctx_index+1;
}
{
std::string new_cmp_name = "eval_st_5";
IsEqual_1_create(mySignalStart+186,36+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[14] = 36+ctx_index+1;
}
{
std::string new_cmp_name = "eval_st_100";
IsEqual_1_create(mySignalStart+162,28+ctx_index+1,ctx,new_cmp_name,myId);
...
cmp_index_ref_load = 8;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[8]].signalStart + 0],&circuitConstants[19]); // line circom 74
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[9]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 86
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 6],&circuitConstants[1]); // line circom 87
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 7;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0]); // line circom 89
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 8],&circuitConstants[20]); // line circom 90
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 0;
cmp_index_ref_load = 0;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[11]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0]); // line circom 92
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 10],&circuitConstants[21]); // line circom 93
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 5;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[12]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0]); // line circom 95
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 12],&circuitConstants[22]); // line circom 96
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 8;
cmp_index_ref_load = 8;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[8]].signalStart + 0]); // line circom 98
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[13]].signalStart + 0],&expaux[1]); // line circom 98
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 14],&circuitConstants[23]); // line circom 99
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 102
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[9]].signalStart + 0],&expaux[1]); // line circom 102
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 16],&signalValues[mySignalStart + 5]); // line circom 103
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 7;
cmp_index_ref_load = 7;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0]); // line circom 105
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0],&expaux[1]); // line circom 105
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 18],&signalValues[mySignalStart + 5]); // line circom 106
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 0;
cmp_index_ref_load = 0;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0]); // line circom 108
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[11]].signalStart + 0],&expaux[1]); // line circom 108
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 20],&signalValues[mySignalStart + 5]); // line circom 109
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 5;
cmp_index_ref_load = 5;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0]); // line circom 111
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[12]].signalStart + 0],&expaux[1]); // line circom 111
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 22],&signalValues[mySignalStart + 5]); // line circom 112
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 8;
cmp_index_ref_load = 8;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[13]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[8]].signalStart + 0]); // line circom 114
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 24],&signalValues[mySignalStart + 5]); // line circom 115
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 14;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[14]].signalStart + 0],&circuitConstants[23]); // line circom 118
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 15;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[15]].signalStart + 0],&signalValues[mySignalStart + 5]); // line circom 120
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[10],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 17]); // line circom 123
Fr_add(&expaux[9],&expaux[10],&signalValues[mySignalStart + 9]); // line circom 123
Fr_add(&expaux[8],&expaux[9],&signalValues[mySignalStart + 19]); // line circom 123
Fr_add(&expaux[7],&expaux[8],&signalValues[mySignalStart + 11]); // line circom 123
Fr_add(&expaux[6],&expaux[7],&signalValues[mySignalStart + 21]); // line circom 123
Fr_add(&expaux[5],&expaux[6],&signalValues[mySignalStart + 13]); // line circom 123
Fr_add(&expaux[4],&expaux[5],&signalValues[mySignalStart + 23]); // line circom 123
Fr_add(&expaux[3],&expaux[4],&signalValues[mySignalStart + 15]); // line circom 123
Fr_add(&expaux[2],&expaux[3],&signalValues[mySignalStart + 25]); // line circom 123
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 26]); // line circom 123
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 27]); // line circom 123
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 16; i++){
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[20]); // line circom 136
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[20]); // line circom 140
while(Fr_isTrue(&expaux[0])){
{
