...
uint get_total_signal_no() {return 402;}

uint get_number_of_components() {return 84;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 204;}
...
mySubcomponents[11] = 30+ctx_index+1;
}
{
...
mySubcomponents[19] = 50+ctx_index+1;
}
{
...
cmp_index_ref_load = 3;
cmp_index_ref_load = 3;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[12]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + 0]); // line circom 93
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[1],&circuitConstants[1],&lvar[0]); // line circom 94
Fr_mul(&expaux[0],&signalValues[mySignalStart + 8],&expaux[1]); // line circom 94
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[13]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 96
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 10],&circuitConstants[22]); // line circom 97
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 6;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[14]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0]); // line circom 99
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 12],&circuitConstants[23]); // line circom 100
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[15]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0]); // line circom 102
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 14],&circuitConstants[24]); // line circom 103
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 4;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[16]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + 0]); // line circom 105
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 16],&circuitConstants[25]); // line circom 106
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 10;
cmp_index_ref_load = 10;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0]); // line circom 108
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[17]].signalStart + 0],&expaux[1]); // line circom 108
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 18],&circuitConstants[26]); // line circom 109
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 3;
cmp_index_ref_load = 3;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + 0]); // line circom 112
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 20],&signalValues[mySignalStart + 7]); // line circom 113
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 115
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 22],&signalValues[mySignalStart + 7]); // line circom 116
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 6;
cmp_index_ref_load = 6;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0]); // line circom 118
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 24],&signalValues[mySignalStart + 7]); // line circom 119
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0]); // line circom 121
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 26],&signalValues[mySignalStart + 7]); // line circom 122
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 4;
cmp_index_ref_load = 4;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + 0]); // line circom 124
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[16]].signalStart + 0],&expaux[1]); // line circom 124
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 28],&signalValues[mySignalStart + 7]); // line circom 125
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 10;
cmp_index_ref_load = 10;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[17]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0]); // line circom 127
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 30],&signalValues[mySignalStart + 7]); // line circom 128
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 18;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[18]].signalStart + 0],&circuitConstants[26]); // line circom 131
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 19;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[19]].signalStart + 0],&signalValues[mySignalStart + 7]); // line circom 133
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_add(&expaux[12],&signalValues[mySignalStart + 9],&signalValues[mySignalStart + 21]); // line circom 136
Fr_add(&expaux[11],&expaux[12],&signalValues[mySignalStart + 11]); // line circom 136
Fr_add(&expaux[10],&expaux[11],&signalValues[mySignalStart + 23]); // line circom 136
Fr_add(&expaux[9],&expaux[10],&signalValues[mySignalStart + 13]); // line circom 136
Fr_add(&expaux[8],&expaux[9],&signalValues[mySignalStart + 25]); // line circom 136
Fr_add(&expaux[7],&expaux[8],&signalValues[mySignalStart + 15]); // line circom 136
Fr_add(&expaux[6],&expaux[7],&signalValues[mySignalStart + 27]); // line circom 136
Fr_add(&expaux[5],&expaux[6],&signalValues[mySignalStart + 17]); // line circom 136
Fr_add(&expaux[4],&expaux[5],&signalValues[mySignalStart + 29]); // line circom 136
Fr_add(&expaux[3],&expaux[4],&signalValues[mySignalStart + 19]); // line circom 136
Fr_add(&expaux[2],&expaux[3],&signalValues[mySignalStart + 31]); // line circom 136
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 32]); // line circom 136
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 33]); // line circom 136
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[20]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 150
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[1],&circuitConstants[1],&lvar[0]); // line circom 151
Fr_mul(&expaux[0],&signalValues[mySignalStart + 34],&expaux[1]); // line circom 151
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 7;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[21]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0]); // line circom 153
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 36],&circuitConstants[22]); // line circom 154
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 0;
cmp_index_ref_load = 0;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[22]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0]); // line circom 156
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 38],&circuitConstants[23]); // line circom 157
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 5;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[23]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0]); // line circom 159
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 40],&circuitConstants[24]); // line circom 160
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 10;
cmp_index_ref_load = 10;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0]); // line circom 162
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[24]].signalStart + 0],&expaux[1]); // line circom 162
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 42],&circuitConstants[25]); // line circom 163
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 166
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 44],&signalValues[mySignalStart + 7]); // line circom 167
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 7;
cmp_index_ref_load = 7;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0]); // line circom 169
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 46],&signalValues[mySignalStart + 7]); // line circom 170
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 0;
cmp_index_ref_load = 0;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0]); // line circom 172
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 48],&signalValues[mySignalStart + 7]); // line circom 173
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 5;
cmp_index_ref_load = 5;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0]); // line circom 175
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[23]].signalStart + 0],&expaux[1]); // line circom 175
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 50],&signalValues[mySignalStart + 7]); // line circom 176
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 10;
cmp_index_ref_load = 10;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[24]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0]); // line circom 178
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 52],&signalValues[mySignalStart + 7]); // line circom 179
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 25;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[25]].signalStart + 0],&circuitConstants[25]); // line circom 182
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 26;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[26]].signalStart + 0],&signalValues[mySignalStart + 7]); // line circom 184
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[10],&signalValues[mySignalStart + 35],&signalValues[mySignalStart + 45]); // line circom 187
Fr_add(&expaux[9],&expaux[10],&signalValues[mySignalStart + 37]); // line circom 187
Fr_add(&expaux[8],&expaux[9],&signalValues[mySignalStart + 47]); // line circom 187
Fr_add(&expaux[7],&expaux[8],&signalValues[mySignalStart + 39]); // line circom 187
Fr_add(&expaux[6],&expaux[7],&signalValues[mySignalStart + 49]); // line circom 187
Fr_add(&expaux[5],&expaux[6],&signalValues[mySignalStart + 41]); // line circom 187
Fr_add(&expaux[4],&expaux[5],&signalValues[mySignalStart + 51]); // line circom 187
Fr_add(&expaux[3],&expaux[4],&signalValues[mySignalStart + 43]); // line circom 187
Fr_add(&expaux[2],&expaux[3],&signalValues[mySignalStart + 53]); // line circom 187
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 54]); // line circom 187
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 55]); // line circom 187
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 56],&circuitConstants[1]); // line circom 198
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 8;
cmp_index_ref_load = 8;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[28]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[8]].signalStart + 0]); // line circom 200
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 58],&circuitConstants[22]); // line circom 201
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 9;
Fr_sub(&expaux[1],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[9]].signalStart + 0]); // line circom 203
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[29]].signalStart + 0],&expaux[1]); // line circom 203
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 60],&circuitConstants[22]); // line circom 204
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 2];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 57],&signalValues[mySignalStart + 59]); // line circom 207
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 61]); // line circom 207
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 30; i++){
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[23]); // line circom 217
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[23]); // line circom 221
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[1]); // line circom 221
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[23]); // line circom 221
