...
uint get_main_input_signal_no() {return 1017;}

uint get_total_signal_no() {return 850035;}

uint get_number_of_components() {return 151001;}

uint get_size_of_input_hashmap() {return 1024;}

uint get_size_of_witness() {return 472029;}

uint get_size_of_constants() {return 1002;}
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 1017;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[26]); // line circom 2022
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[0]); // line circom 2023
while(Fr_isTrue(&expaux[0])){
{
...
// load src
Fr_sub(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 2024
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 2023
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[0]); // line circom 2023
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 2022
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[26]); // line circom 2022
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[0]); // line circom 2029
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 2029
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[0]); // line circom 2029
