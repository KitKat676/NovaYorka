...
uint get_total_signal_no() {return 749;}

uint get_number_of_components() {return 133;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 576;}
...
uint csoffset = mySignalStart+358;
...
IsAlphanumeric_8_create(mySignalStart+182,22+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[26] = 22+ctx_index+1;
}
{
std::string new_cmp_name = "is_slash";
IsEqual_7_create(mySignalStart+514,104+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[27] = 104+ctx_index+1;
}
{
std::string new_cmp_name = "is_CR";
IsEqual_7_create(mySignalStart+164,16+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[28] = 16+ctx_index+1;
}
{
std::string new_cmp_name = "is_SQ";
IsEqual_7_create(mySignalStart+176,20+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[29] = 20+ctx_index+1;
}
{
std::string new_cmp_name = "is_backsl";
IsEqual_7_create(mySignalStart+340,46+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[30] = 46+ctx_index+1;
}
{
std::string new_cmp_name = "is_star";
IsEqual_7_create(mySignalStart+520,106+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[31] = 106+ctx_index+1;
}
{
std::string new_cmp_name = "is_DQ";
IsEqual_7_create(mySignalStart+170,18+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[32] = 18+ctx_index+1;
}
{
std::string new_cmp_name = "is_bt";
IsEqual_7_create(mySignalStart+346,48+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[33] = 48+ctx_index+1;
}
{
std::string new_cmp_name = "eq_cmt";
IsEqual_7_create(mySignalStart+140,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[34] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "eq_qut";
IsEqual_7_create(mySignalStart+158,14+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[35] = 14+ctx_index+1;
}
{
std::string new_cmp_name = "eq_mlcmt";
IsEqual_7_create(mySignalStart+152,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[36] = 12+ctx_index+1;
}
{
std::string new_cmp_name = "eq_dqt";
IsEqual_7_create(mySignalStart+146,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[37] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "eq_bkt";
IsEqual_7_create(mySignalStart+134,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[38] = 6+ctx_index+1;
}
{
uint aux_create = 39;
int aux_cmp_num = 112+ctx_index+1;
uint csoffset = mySignalStart+538;
uint aux_dimensions[1] = {10};
for (uint i = 0; i < 10; i++) {
...
IsEqual_7_create(mySignalStart+532,110+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[49] = 110+ctx_index+1;
}
{
std::string new_cmp_name = "is_holding";
IsEqual_7_create(mySignalStart+352,50+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[50] = 50+ctx_index+1;
}
{
std::string new_cmp_name = "is_state_accept";
IsEqual_7_create(mySignalStart+526,108+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[51] = 108+ctx_index+1;
}
{
std::string new_cmp_name = "cmteol_st_0";
IsEqual_7_create(mySignalStart+116,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[52] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "cmteol_st_1";
IsEqual_7_create(mySignalStart+122,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[53] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "cmteol_st_2";
IsEqual_7_create(mySignalStart+128,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[54] = 4+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[0];
// load src
...
Fr_lt(&expaux[0],&lvar[11],&circuitConstants[3]); // line circom 174
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[11])) + 0)];
// load src
...
PFrElement aux_dest = &lvar[11];
// load src
Fr_add(&expaux[0],&lvar[11],&circuitConstants[2]); // line circom 174
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[11],&circuitConstants[3]); // line circom 174
...
cmp_index_ref_load = 27;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[52]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[27]].signalStart + 0]); // line circom 184
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 110],&circuitConstants[2]); // line circom 185
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 27;
cmp_index_ref_load = 27;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[53]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[27]].signalStart + 0]); // line circom 187
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 112],&circuitConstants[20]); // line circom 188
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 28;
Fr_sub(&expaux[1],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[28]].signalStart + 0]); // line circom 190
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[54]].signalStart + 0],&expaux[1]); // line circom 190
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 114],&circuitConstants[20]); // line circom 191
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 111],&signalValues[mySignalStart + 113]); // line circom 194
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 115]); // line circom 194
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 55; i++){
