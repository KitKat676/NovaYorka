...
while(Fr_isTrue(&expaux[0])){
Fr_neq(&expaux[4],&lvar[11],&circuitConstants[19]); // line circom 172
Fr_neq(&expaux[5],&lvar[11],&circuitConstants[21]); // line circom 172
Fr_land(&expaux[3],&expaux[4],&expaux[5]); // line circom 172
Fr_neq(&expaux[4],&lvar[11],&circuitConstants[22]); // line circom 172
Fr_land(&expaux[2],&expaux[3],&expaux[4]); // line circom 172
Fr_neq(&expaux[3],&lvar[11],&circuitConstants[23]); // line circom 172
Fr_land(&expaux[1],&expaux[2],&expaux[3]); // line circom 172
Fr_neq(&expaux[2],&lvar[11],&circuitConstants[24]); // line circom 172
...
cmp_index_ref_load = 34;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[66]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[34]].signalStart + 0]); // line circom 272
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 145],&circuitConstants[2]); // line circom 273
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 31;
cmp_index_ref_load = 31;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[67]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[31]].signalStart + 0]); // line circom 275
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 147],&circuitConstants[20]); // line circom 276
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 68;
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[68]].signalStart + 0],&circuitConstants[2]); // line circom 278
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 31;
cmp_index_ref_load = 31;
Fr_sub(&expaux[1],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[31]].signalStart + 0]); // line circom 280
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[67]].signalStart + 0],&expaux[1]); // line circom 280
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 34;
cmp_index_ref_load = 34;
Fr_sub(&expaux[1],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[34]].signalStart + 0]); // line circom 281
Fr_mul(&expaux[0],&signalValues[mySignalStart + 150],&expaux[1]); // line circom 281
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[2],&signalValues[mySignalStart + 146],&signalValues[mySignalStart + 148]); // line circom 284
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 149]); // line circom 284
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 151]); // line circom 284
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 69; i++){
