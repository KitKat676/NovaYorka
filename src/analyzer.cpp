...
uint get_total_signal_no() {return 254005;}

uint get_number_of_components() {return 57001;}

uint get_size_of_input_hashmap() {return 512;}

uint get_size_of_witness() {return 107503;}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[38]); // line circom 1024
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
