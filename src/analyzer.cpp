...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[12]); // line circom 82
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (Fr_toInt(&lvar[5]) + 2)) + 12)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsEqual_7_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[2]); // line circom 82
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[12]); // line circom 82
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[14]); // line circom 88
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[2]); // line circom 88
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[14]); // line circom 88
...
Fr_lt(&expaux[0],&lvar[6],&circuitConstants[12]); // line circom 98
while(Fr_isTrue(&expaux[0])){
{
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[6])) + 0);
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 10)]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].signalStart + 0]); // line circom 99
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[6])) + 23);
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[6])) + 25)],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 23)]].signalStart + 0]); // line circom 100
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[1],&lvar[6],&circuitConstants[2]); // line circom 101
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[6])) + 35)],&expaux[1]); // line circom 101
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[6])) + 45)]); // line circom 102
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[6];
// load src
Fr_add(&expaux[0],&lvar[6],&circuitConstants[2]); // line circom 98
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[6],&circuitConstants[12]); // line circom 98
